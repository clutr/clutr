...
#Task-Latent-Adversary Arguments

parser.add_argument(
    '--use_latent_task',
    type=bool,
    default=False,
    help='Use Latent Task UED')

parser.add_argument(
    "--deterministic_vae",
    type=bool, default=True,
    help="argmax from VAE instead of sampling from softmax while generating parameter i.e., .")
...
parser.add_argument(
    '--latent_task_exp',
    type=str,
    default='multistep_discrete',
    choices=['multistep_discrete', 'singlestep_continuous'],
    help='Type of adversary for Task UED')
...
parser.add_argument(
    '--task_ae',
    type=str,
    default='task_embed/clutr_RVAE/data/final/vae-recons-79-iter-1000000-latent-64-sequential-batch-train_1000000_32_trained_RVAE',
    help='Path to pretrained Variational AutoEncoder')

parser.add_argument(
    '--latent_space_discrete_max',
    type=int,
    default=250,
    help='Max value of task adversary action')

parser.add_argument(
    '--latent_dim_max',
    type=int,
    default=4,
    help='Max numerical value of latent dim')
...
parser.add_argument(
    ...
    type=int,
    default=512,
    help='Embedding Size For Location for Minigrid, Carracing')

parser.add_argument(
    '--word2_embed_size',
    type=int,
    default=None,
    help='Embedding Size For Object for Minihack Environment')
...
parser.add_argument(
    ...
    type=str,
    default='scaled_tanh',
    choices=['tanh', 'none', 'scaled_tanh'],
    help='Only used to load saved RVAE with the mentioned activation')

parser.add_argument(
    '--activation_scalar',
    type=int,
    default=0,
    help='Only used to load saved RVAE with scaled tanh')
